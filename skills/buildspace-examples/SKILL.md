...
description: Preferred patterns and recipes for building features with the BuildSpace SDK in your Next.js project. Use when adding authentication UI, route protection, server actions, event tracking, file storage, email notifications, or protected API routes.
---
